...
var url = '';
var html = '';
var nurl1 = 'https://api.nytimes.com/svc/search/v2/articlesearch.json?q=';
var nurl2 = '&api-key=xd4upDk8zDAqQVbGAnRce0tkmYA2sOgn';

var gurl1 = 'https://content.guardianapis.com/search?q=';
var gurl2 = '&api-key=385abf6e-f3d2-43ea-bd35-ee85716e05d5&show-blocks=all';

function getURL(req){
    if(req.query.tabName == "true"){
        url = gurl1 + req.query.qKey + gurl2;
    } else {
        url = nurl1 + req.query.qKey + nurl2;
    }
